...
function formatFilename(format, data) {
    let result = format;
...
const sessionLoggerPlugin = {
    ...
    register(api) {
        ...
        const createSessionFile = (sessionKey, forceNew = false) => {
        ...
        const writeLog = (sessionKey, entry) => {
        ...
        api.registerHook("message", async (event) => {
        ...
        api.registerHook("agent", async (event) => {
