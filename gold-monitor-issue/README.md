...
| Task | 標題 | 負責人 | 優先順序 | 狀態 |
|------|------|--------|---------|------|
| T1 | 請檢查及修正 黃金存摺價格監控 的問題。發現歷史資料有誤，故顯形無法正常顯示 | 未指派 | 中 | ✅ done |
| T2 | 請排定後續觀察及回報驗證狀況，持續三天，每天個檢查及比對線上價位是否與監控相同並回報比對結果 | 未指派 | 中 | ✅ done |
| T3 | 請依照修正後結果，更新TASK及HOWTO。並回報完成進度及狀況。 | 未指派 | 中 | ⬜ pending |
| T4 | 更新為同時顯示黃金存摺買入/賣出價格 | 未指派 | 中 | ✅ done |
