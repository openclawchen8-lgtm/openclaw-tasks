...
| Task | 標題 | 負責人 | 優先順序 | 狀態 |
|------|------|--------|---------|------|
| T1 | ClawHub Skills 備份至 GitHub | 未指派 | 中 | ✅ done |
| T2 | Howto 文檔備份至 GitHub | 未指派 | 中 | ✅ done |
| T3 | 自動備份腳本 sync_all.sh | 未指派 | 中 | ✅ done |
| T4 | 排程設定備份確認 | 未指派 | 中 | ✅ done |
| T5 | 備份大小優化（排除 .git/ node_modules/） | 未指派 | 中 | ✅ done |
