...
| Task | 標題 | 負責人 | 優先順序 | 狀態 |
|------|------|--------|---------|------|
| T1 | Gateway 不穩定與任務中斷預防實作方式報告 | None | 中 | ✅ done |
| T2 | git 配置異動確認流程規範 | None | 中 | ✅ done |
| T3 | 如何防止專案或任務啟動後，因 Gateway 不穩定或任何原 | 碼農 1 號 | 中 | ✅ done |
| T4 | 日後git配置的相關異動(包含新增,修改,刪除)，皆與和我先 | 碼農 2 號 | 中 | ✅ done |
